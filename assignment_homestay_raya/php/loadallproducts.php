<?php
	...
	if ($search =="all"){
			$sqlloadproduct = "SELECT * FROM table_product ORDER BY product_date DESC";
	}else{
		$sqlloadproduct = "SELECT * FROM table_product WHERE product_name LIKE '%$search%' ORDER BY product_date DESC";
	}
